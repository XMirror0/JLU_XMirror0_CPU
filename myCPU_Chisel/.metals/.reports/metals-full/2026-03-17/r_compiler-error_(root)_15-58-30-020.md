...
### scala.ScalaReflectionException: value adder_res_ext is not a method
...
class ALU extends Module {
    ...
    u_div_signed.io.m_axis_dout_tready      := cpu_ready
    val div_mod_result                      = u_div_signed.io.m_axis_dout_tdata

    u_div_unsigned.io.aclk                    := clock
    u_div_unsigned.io.s_axis_dividend_tvalid  := data_valid && is_unsigned_div
    u_div_unsigned.io.s_axis_divisor_tvalid   := data_valid && is_unsigned_div
    u_div_unsigned.io.s_axis_dividend_tdata   := saved_src1
    u_div_unsigned.io.s_axis_divisor_tdata    := saved_src2
    u_div_unsigned.io.m_axis_dout_tready      := cpu_ready
    val divu_modu_result                      = u_div_unsigned.io.m_axis_dout_tdata
    ...
    val adder_res_ext = Cat(0.U(1.W),adder1)+
